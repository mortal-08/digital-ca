...
const features = [
  { icon: Shield, title: 'Secure Vault', desc: 'Bank-grade encryption for all documents' },
  { icon: TrendingUp, title: 'Real-time Tracking', desc: 'Monitor your compliance status live' },
  { icon: Calculator, title: 'Smart Filing', desc: 'AI-assisted tax and GST filing' },
  { icon: FileText, title: 'Easy Access', desc: 'All your reports in one dashboard' },
];
